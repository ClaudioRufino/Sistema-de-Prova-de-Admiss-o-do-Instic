    ...
    <script src="{{url('light/js/d3.min.js')}}"></script>
    <script src="{{url('light/js/topojson.min.js')}}"></script>
    <script src="{{url('light/js/datamaps.all.min.js')}}"></script>
    <script src="{{url('light/js/datamaps-zoomto.js')}}"></script>
    <script src="{{url('light/js/datamaps.custom.js')}}"></script>
    <script src="{{url('light/js/Chart.min.js')}}"></script>
    ...
    <script src="{{url('light/js/gauge.min.js')}}"></script>
    <script src="{{url('light/js/jquery.sparkline.min.js')}}"></script>
    <script src="{{url('light/js/apexcharts.min.js')}}"></script>
    <script src="{{url('light/js/apexcharts.custom.js')}}"></script>
