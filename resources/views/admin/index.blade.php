    ...
    <div class="row justify-content-center">
      <div class="col-12">
        <div class="row align-items-center mb-2">
          <div class="col">
            <h2 class="h5 page-title" style="color:rgb(46, 89, 230)"></i><em>Admin - {{$nome}}</em></h2>
          </div>
          <div class="col-auto">
            ...
            <div id="meuCarrocel" class="carousel slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner" style="height:500px">
                <div class="carousel-item active">
                  <img 
                      class="d-block w-100" 
                      src="{{url('light/assets/images/isutic-home.jpg')}}" 
                      alt="First slide" 
                ...
                <div class="carousel-item">
                  <img class="d-block w-100" src="{{url('light/assets/images/isutic-3.jpg')}}" alt="Second slide" />
                  <div class="carousel-caption d-none d-md-block">
                  </div>
                </div>
                <div class="carousel-item">
              ...
              <div class="card-body">
                ...
                <div class="row border-top">
                  <div class="col-md-6 pt-4">
                    ...
                    <p class="mb-0 text-muted">Total Inscritos</p>
                  </div>
                  <div class="col-md-6 pt-4">
